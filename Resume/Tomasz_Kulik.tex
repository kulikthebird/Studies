...
\begin{minipage}[c]{0.2\textwidth}
  \begin{tikzpicture}
    ...
    \node at (0.0, -0.7) {\includegraphics[width = 3.2cm]{diploma2}};    % (x, y) and width=zoom
  \end{tikzpicture}
  \hfill\vline\hfill
\end{minipage}
...
\begin{entrylist}
  ...
  {
    I have started work in a 5G project for a telco company. The work have been
...
{\tiny
  ...
  SomeFancyCompanyNameHere Ltd. for the purpose of conducting
  recruitment for the position for which I am applying. I also consent
  to processing of my personal data by SomeFancyCompanyNameHere Ltd.
